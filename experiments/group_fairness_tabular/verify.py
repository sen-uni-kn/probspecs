...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-p",
        "--population-model",
        choices=("independent", "factor_analysis"),
        required=True,
    )
    parser.add_argument(
        "-c",
    ...
    networks = {"classifier": classifier, "pop_model": pop_model}
    ...
    if args.dataset == "Adult":
        ...
        female = pop_model_func[:, female_i] >= 1.0
        male = pop_model_func[:, male_i] >= 1.0
